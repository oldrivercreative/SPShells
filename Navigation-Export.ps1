...
$SourceTermGroupName = "Site Collection - example.com"
$SourceTermSetName = "Top Navigation"
$ExportFileName = "Navigation.xml"
...
function WriteTerm([Microsoft.SharePoint.Taxonomy.Term] $Term){
  ...
  # SimpleLinkUrl
  if($Term.LocalCustomProperties._Sys_Nav_SimpleLinkUrl -ne $null){
    $XmlWriter.WriteAttributeString("SimpleLinkUrl", $Term.LocalCustomProperties._Sys_Nav_SimpleLinkUrl)
  }

  # TargetUrl
  if($Term.LocalCustomProperties._Sys_Nav_TargetUrl -ne $null){
    $XmlWriter.WriteAttributeString("TargetUrl", $Term.LocalCustomProperties._Sys_Nav_TargetUrl)
  }

  # TargetUrlForChildTerms
  if($Term.LocalCustomProperties._Sys_Nav_TargetUrlForChildTerms -ne $null){
    $XmlWriter.WriteAttributeString("TargetUrlForChildTerms", $Term.LocalCustomProperties._Sys_Nav_TargetUrlForChildTerms)
  }
  ...
  # Exclusions
  if($Term.LocalCustomProperties._Sys_Nav_ExcludedProviders -ne $null){
    $XmlWriter.WriteAttributeString("Exclusions", $Term.LocalCustomProperties._Sys_Nav_ExcludedProviders)
  }
